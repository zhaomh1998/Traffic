...
apiKey1 = '03bbafe4830ec25a270d921217d9333c'
apiKey2 = '83ffa9e7b8899210d604a202b493f14c'
thingSpeakAPI = 'LUJX2YO0VZVVGCBM'
...
ningguoY = '31.847991'
ningguoRad = '500'
#logFile = open(datetime.now(cst).strftime(logFileFormat) + '.log', 'a')
...
def main():
    ...
    while True:
        try:
            ...
            zhanqian.close()
            ningguo.close()
            #logFile.write(logTime() + ' Server Closed by keyboardInterrupt')
            #logFile.close()
